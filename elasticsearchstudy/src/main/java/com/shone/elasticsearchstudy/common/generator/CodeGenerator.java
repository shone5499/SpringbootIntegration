package com.shone.elasticsearchstudy.common.generator;
...
public class CodeGenerator {
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.shone.elasticsearchstudy";
    // xml文件路径
    ...
    // controller 父类地址
    private static final String SUPER_CONTROLLER_CLASS_PATH = "com.shone.elasticsearchstudy.controller.BaseController";
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/elasticsearchstudy/src/main/java");
...
//                return projectPath + "/elasticsearchstudy/src/main/resources/mapper/" + packageConfig.getModuleName()
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                //没有模块名的输出
                return projectPath + "/elasticsearchstudy/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
